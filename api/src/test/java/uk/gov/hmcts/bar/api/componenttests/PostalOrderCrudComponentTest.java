...
public class PostalOrderCrudComponentTest extends ComponentTestBase {
	...
	public void whenPostalOrderPaymentInstructionDetails_thenCreatePostalOrderPaymentInstruction() throws Exception {
		PostalOrder proposedPostalOrderPaymentInstructionRequest = postalOrderPaymentInstructionRequestWith()
				.payerName("Mr Payer Payer").amount(500).currency("GBP").status("D").postalOrderNumber("000000")
				.build();
		...
		restActions.post("/postal-orders", proposedPostalOrderPaymentInstructionRequest).andExpect(status().isCreated())
				.andExpect(body().as(PostalOrderPaymentInstruction.class, postalOrderPaymentInstruction -> {
					assertThat(postalOrderPaymentInstruction).isEqualToComparingOnlyGivenFields(
							postalOrderPaymentInstructionRequestWith().payerName("Mr Payer Payer").amount(500)
									.currency("GBP").status("D").postalOrderNumber("000000"));
				}));
	}
	...
	public void whenPostalOrderInstructionWithInvalidCurrency_thenReturn400() throws Exception {
		PostalOrder proposedPostalOrderPaymentInstructionRequest = postalOrderPaymentInstructionRequestWith()
				.payerName("Mr Payer Payer").amount(500).currency("xxx").postalOrderNumber("000000").build();
	...
	public void whenPostalOrderInstructionWithInvalidPostalOrderNumber_thenReturn400() throws Exception {
		PostalOrder proposedPostalOrderPaymentInstructionRequest = postalOrderPaymentInstructionRequestWith()
				.payerName("Mr Payer Payer").amount(500).currency("GBP").status("D").postalOrderNumber("xxxxxx")
				.build();
	...
	public void whenPostalOrderPaymentInstructionIsSubmitted_expectStatus_200() throws Exception {
		...
		PaymentInstructionUpdateRequest stattusUpdateRequest = paymentInstructionUpdateRequestWith().status("P")
				.build();

		restActions.post("/postal-orders", proposedPostalOrderPaymentInstructionRequest)
				.andExpect(status().isCreated());

		restActions.patch("/payment-instructions/1", stattusUpdateRequest).andExpect(status().isOk());
		...
		restActions.get("/payment-instructions?payerName=Mr Payer Payer").andExpect(status().isOk())
				.andExpect(body().as(List.class, postalOrderPaymentInstructionList -> {
					assertThat(postalOrderPaymentInstructionList.get(0)).isEqualToComparingOnlyGivenFields(
							postalOrderPaymentInstructionWith().payerName("Mr Updated Payer").amount(600)
									.currency("GBP").status("D").postalOrderNumber("000000"));
				}));
	...
	@Test
	public void whenSearchNonExistingPostalOrderPaymentInstructionByPayerName_expectStatus_200AndEmptyList()
			throws Exception {
		PostalOrder proposedPostalOrderPaymentInstructionRequest = postalOrderPaymentInstructionRequestWith()
				.payerName("Mr Payer Payer").amount(500).currency("GBP").status("D").postalOrderNumber("000000")
				.build();
		...
		restActions.get("/payment-instructions?payerName=NonExisting").andExpect(status().isOk())
				.andExpect(body().as(List.class,
						postalOrderPaymentInstructionList -> assertTrue(postalOrderPaymentInstructionList.isEmpty())));
	...
	public void whenPostalOrderPaymentInstructionIsSubmittedByPostClerk_expectStatus_200() throws Exception {
		...
		PostalOrder updatedPostalOrderPaymentInstructionRequest = postalOrderPaymentInstructionRequestWith()
				.payerName("Mr Updated Payer").amount(6000).currency("GBP").status("D").postalOrderNumber("000000")
				.build();

		restActions.post("/postal-orders", proposedPostalOrderPaymentInstructionRequest)
				.andExpect(status().isCreated());

		restActions.put("/postal-orders/1", updatedPostalOrderPaymentInstructionRequest).andExpect(status().isOk());
	...
	public void whenNonExistingPostalOrderPaymentInstructionIsSubmittedByPostClerk_expectStatus_404() throws Exception {
		...
		restActions.put("/postal-orders/1000", updatedPostalOrderPaymentInstructionRequest)
