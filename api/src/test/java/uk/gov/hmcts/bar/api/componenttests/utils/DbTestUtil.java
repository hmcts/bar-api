...
public final class DbTestUtil {
    ...
    private static final String INSERT_CARD_PI_QUERY_TRANSFERRED_TO_PAYHUB_YES =
        "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id,bgc_number,transferred_to_payhub,report_date) VALUES (1,'John Doe',null,'CARD',{ts '2018-03-25 23:32:23.871'},600,'GBP',null,'TTB',null,'Y431',1,'Process','1234','123456',true,CURRENT_TIMESTAMP);";
    ...
    private static final String INSERT_PO_PI_QUERY_TRANSFERRED_TO_PAYHUB_YES =
        "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id,bgc_number,transferred_to_payhub) VALUES (1,'John Doe',null,'POSTAL_ORDER',{ts '2018-03-25 23:32:23.871'},600,'GBP',null,'STP',null,'Y431',1,'Process','1234','123456',true);\n"+
        "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id,bgc_number,transferred_to_payhub) VALUES (2,'John Doe',null,'POSTAL_ORDER',{ts '2018-03-25 23:32:23.871'},600,'GBP',null,'STP',null,'Y610',1,'Process','1234','123456',true);";
    ...
    private static final String INSERT_BAR_USER =
        "INSERT INTO bar_user values ('1234','1234-fn','1234-ln','post.clerk@hmcts.net','bar-post-clerk');";
    ...
    private static final String INSERT_PI_QUERY =
        ...
        "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id) VALUES (3,'John Doe',null,'CASH',{ts '2018-03-25 23:36:11.207'},50000,'GBP',null,'TTB',null,'Y431',3,'Process','1234');\n" +
        ...
        "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,authorization_code,user_id,bgc_number,transferred_to_payhub,payhub_error,report_date,action_reason,action_comment) VALUES (891,'Brett','312323','CHEQUE',{ts '2018-11-08 17:08:34.391'},55000,'GBP',null,'TTB',null,'Y431',2,'Process',null,'1234','123456',false,null,null,null,null);" +
        "INSERT INTO case_fee_detail (case_fee_id,payment_instruction_id,fee_code,amount,fee_description,fee_version,case_reference,remission_amount,remission_benefiter,remission_authorisation,refund_amount) " +
            "VALUES (1,1,'X0165',55000,'Filing an application for a divorce, nullity or civil partnership dissolution – fees order 1.2.','1','12345',5000,'sdfsf','dsfsf',null);";
    ...
    public static String getInstructionStatusHistory(String userId) {
        return "INSERT INTO payment_instruction_status (payment_instruction_id,status,bar_user_id,update_time) VALUES (1,'TTB','" + userId + "',{ts '2019-01-21 20:48:40.0'});" +
            "INSERT INTO payment_instruction_status (payment_instruction_id,status,bar_user_id,update_time) VALUES (2,'P','" + userId + "',{ts '2019-01-21 20:48:40.0'});" +
            "INSERT INTO payment_instruction_status (payment_instruction_id,status,bar_user_id,update_time) VALUES (3,'TTB','" + userId + "',{ts '2019-01-21 20:48:40.0'});" +
            "INSERT INTO payment_instruction_status (payment_instruction_id,status,bar_user_id,update_time) VALUES (4,'A','" + userId + "',{ts '2019-01-21 20:48:40.0'});" +
            ...
            "INSERT INTO payment_instruction_status (payment_instruction_id,status,bar_user_id,update_time) VALUES (891,'TTB','" + userId + "',{ts '2019-01-21 20:48:40.0'});";
    }

    public static String getPIQuery(String userId) {
        return "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id) VALUES (1,'John Doe',null,'CARD',{ts '2018-03-25 23:32:23.871'},50000,'GBP',null,'TTB',null,'Y431',1,'Process','" + userId + "');\n" +
            "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id) VALUES (2,'John Doe',null,'CARD',{ts '2018-03-25 23:36:11.207'},50000,'GBP','123','P',null,'Y431',2,null,'4321');\n" +
            "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id) VALUES (3,'John Doe',null,'CASH',{ts '2018-03-25 23:36:11.207'},50000,'GBP',null,'TTB',null,'Y431',3,'Process','" + userId + "');\n" +
            "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,user_id) VALUES (4,'Jane Doe',null,'CHEQUE',{ts '2018-03-25 23:36:11.207'},50000,'GBP',null,'RDM',null,'Y431',3,'Process','5678');\n" +
            "INSERT INTO payment_instruction (id,payer_name,cheque_number,payment_type_id,payment_date,amount,currency,all_pay_transaction_id,status,postal_order_number,site_id,daily_sequence_id,action,authorization_code,user_id,bgc_number,transferred_to_payhub,payhub_error,report_date,action_reason,action_comment) VALUES (891,'Brett','312323','CHEQUE',{ts '2018-11-08 17:08:34.391'},55000,'GBP',null,'TTB',null,'Y431',2,'Process',null,'" + userId + "','123456',false,null,null,null,null);" +
            "INSERT INTO case_fee_detail (case_fee_id,payment_instruction_id,fee_code,amount,fee_description,fee_version,case_reference,remission_amount,remission_benefiter,remission_authorisation,refund_amount) " +
            "VALUES (1,1,'X0165',55000,'Filing an application for a divorce, nullity or civil partnership dissolution – fees order 1.2.','1','12345',5000,'sdfsf','dsfsf',null);";
    }

    public static String getBarUser(String userId) {
        return "INSERT INTO bar_user values ('" + userId + "','1234-fn','1234-ln','post.clerk@hmcts.net','bar-post-clerk');";
    }
    ...
    public static void insertPaymentInstructions(ApplicationContext applicationContext, String userId) throws SQLException {
        DataSource dataSource = applicationContext.getBean(DataSource.class);
        try (Connection dbConnection = dataSource.getConnection(); Statement stmt = dbConnection.createStatement()) {
            ...
            stmt.executeQuery(getPIQuery(userId));
            stmt.executeQuery(getBarUser(userId));
            stmt.executeQuery(getInstructionStatusHistory(userId));
        }
    }
