...
public interface SiteRepository extends CrudRepository<Site, String> {
    ...
    @Query(value = "SELECT bu.email, bu.forename, bu.surname from user_site us join bar_user bu on us.user_email = upper(bu.email) where us.site_id=:siteId", nativeQuery = true)
