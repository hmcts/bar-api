...
public interface PaymentInstructionStatusRepository
    ...
    @Query(name = "PIReportDetails", value = "SELECT new uk.gov.hmcts.bar.api.data.model.PaymentInstructionStatusHistory"
        ...
        + " FROM PaymentInstructionStatus pis1 join PaymentInstruction pi on pi.id = pis1.paymentInstructionStatusReferenceKey.paymentInstructionId where pi.siteId= :siteId and  pis1.paymentInstructionStatusReferenceKey.status in ('STP','C') "
