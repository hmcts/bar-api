...
public interface PayhubPaymentInstructionRepository extends BaseRepository<PayhubPaymentInstruction,
    Integer>, JpaSpecificationExecutor<PayhubPaymentInstruction> {
}
