package uk.gov.hmcts.bar.api.security.authcheckerconfiguration;
...
public class AuthCheckerConfiguration {
    ...
    public Function<HttpServletRequest, Collection<String>> authorizedRolesExtractor() {
        return (any) -> Stream.of("super", "bar-fee-clerk", "bar-senior-clerk", "bar-delivery-manager", "bar-post-clerk" , "payments")
