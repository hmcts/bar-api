    ...
    node {
        try {
            ...
            stage('Build') {
                ...
                rtGradle.run buildFile: 'build.gradle', tasks: 'clean build dependencyCheck sonarqube -Dsonar.host.url=https://sonar.reform.hmcts.net/', buildInfo: buildInfo
            }
...
//            }
            ...
            onMaster {
                ...
                stage("Publish RPM") {
					...
					version = "{bar_api_version: ${rpmVersion} }"
